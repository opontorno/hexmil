...
from models.densenet3d_classifier import build_densenet3d_classifier
...
def get_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description='Train DenseNet121 3D baseline')
    ...
    p.add_argument('--pretrained', action='store_true', default=False,
                   help='Not supported for MONAI DenseNet121 in 3D; keep disabled.')
...
def main():
    ...
    print(f'Model: densenet121_3d  params={sum(p.numel() for p in model.parameters()):,}')
    ...
    if args.use_wandb:
        ...
        run_name = args.run_name or f'densenet121_3d_K{args.K}'
