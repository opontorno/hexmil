...
def build_parser() -> argparse.ArgumentParser:
    ...
    sl.add_argument("--s_batch_size",     type=int,   default=16)
    sl.add_argument("--s_lr",             type=float, default=1e-4)
    sl.add_argument("--s_weight_decay",   type=float, default=1e-5)
    ...
    vl.add_argument("--v_weight_decay",  type=float, default=1e-5)
...
def _infer_slice_ckpt_dir(args) -> Path:
    ...
    if args.s_run_name is not None:
        ...
        run_tag  = (f"trained_on_{mods_tag}") # canonical
